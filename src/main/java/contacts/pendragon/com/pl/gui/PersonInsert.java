...
public class PersonInsert extends JDialog {
    ...
    public PersonInsert(JFrame parent, MainWindow mainWindow) {
    ...
    private void savePerson() {
        ...
        try {
            if (nameField.getText().equals("") && surnameField.getText().equals("") &&
                ...
                personNew.name.setValue(this.nameField.getText().equals("") ? null : this.nameField.getText());
                personNew.surname.setValue(this.surnameField.getText().equals("") ? null : this.surnameField.getText());
                personNew.com_name.setValue(this.comNameField.getText().equals("") ? null : this.comNameField.getText());
                personNew.description.setValue(this.descriptionField.getText().equals("") ? null : this.descriptionField.getText());
                personNew.save();
